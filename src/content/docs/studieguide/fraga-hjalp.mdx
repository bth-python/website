...
Jag rekommenderar att först läsa [Lärarstöd och handledning](studieguide/lararstod-och-handledning), där lär ni hur ni kan tänka om att ställa frågor. Här lär vi oss hur vi ställer dem.
...
När ni ber om hjälp **formulera en fråga istället för att skriva "Hej min kod funkar inte"**. Om ni inte skriver en fråga vet vi inte hur vi ska hjälpa dig och måste be dig skicka med de sakerna som det står om här. För tips om hur ni formulerar frågan, kolla in när [Mikael pratar med sin gummi anka](studieguide/lararstod-och-handledning#anka).
