---
title: LEGB regeln och scopes i Python
---
...
Alla kodexempel från denna övningen finns går att hitta [här](https://github.com/dbwebb-se/python/tree/master/example/scope). Funktions- och variabelnamnen har ändrats i kodexemplen då funktioner i samma modul måste ha unika namn.
