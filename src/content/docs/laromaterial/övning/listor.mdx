---
title: "Kom igång med datatypen lista i Python"
description: Lär dig om listor.
sidebar:
  order: 0410
---
...
import var1Image from '@assets/img/ovning/python-list-shopping.png';
import var2Image from '@assets/img/ovning/shopping_list.png';


<Figure
    src={var1Image}
    caption="Visar en shoppinglista i python."
    class="right"
/>
...
<Figure
    src={var2Image}
    caption="Visar en shoppinglista med element och index."
    class="center"
/>


Det första elementet, "köttfärs",  i listan `shopping` har position 0 och det sista elementet, "röd lök", har position 4 (antalet element - 1).
...
>>> print(shopping)                                                        
['köttfärs', 'morötter', 'grädde', 'gul lök', 'röd lök']
```
...
<YouTube
    id="subD0Mhm7ks" 
    title="Andreas introducerar listor."
/>
...
En lista i Python är implementerad som en `<class 'list'>` och har ett antal metoder kopplade till sig. Vi kan läsa om dessa [metoder i manualen](https://docs.python.org/3.13/tutorial/datastructures.html), eller få fram information om dem direkt i terminalen.
...
<YouTube
    id="2H5ms6QZlPI" 
    title="Andreas går igenom listmetoder."
/>
...
<YouTube
    id="nLANWlxXg3o" 
    title="Andreas går igenom listor med loopar."
/>
...
Om du har gjort [Ett simpelt tärningsspel](../loopar/#ett-simpelt-tärningsspel) i övningen i kmom02 kan du fortsätta på den koden. Nu ska du göra ett simpelt tärningsspel där användare ska skriva in hur många tärningar som ska slås, spara varje slag i en lista. Räkna sen ut medelvärde och totalsumma för slagen och skriv ut det och alla slag. Som extrauppgift ska programmet inte avslutas när utskriften är gjord utan istället ska användaren kunna skriva in ett till antal tärningslag eller välja att avsluta.

<YouTube
    id="YU_1IK3Cbzs" 
    title="Andreas löser uppgiften."
/>
...
<YouTube
    id="KnNwrr6tMq8" 
    title="Andreas går igenom slicing."
/>
...
<YouTube
    id="AyFcjm1v74s" 
    title="Andreas går igenom hur man kan slå ihop listor med slicing."
/>
...
<YouTube
    id="8H9mkvdAoQQ" 
    title="Andreas går igenom split()."
/>
...
Detta var en introduktion till listor i Python. Du har lärt sig att skapa listor och ändra i listor.
