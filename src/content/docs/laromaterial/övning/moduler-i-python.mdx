...
I slutet av övningen [Funktioner, argument och returvärden](../../laromaterial/övning/funktioner-argument-och-returvarden_v2) ser vår funktion ut på följande sätt.
