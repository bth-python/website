...
Vi fortsätter på exemplet från övningen [Funktioner, argument och returvärden](../funktioner-argument-och-returvarden_v2) så har du inte gjort den övningen rekommenderar vi att du gör den först.
