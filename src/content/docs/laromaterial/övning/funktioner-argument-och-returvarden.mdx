...
## Formattering för bättre utskrifter
...
Alla kodexempel från denna övningen finns går att hitta [här](https://github.com/dbwebb-se/python/tree/master/example/functions/functions_v2.py). Funktionsnamnen har ändrats i kodexemplett då funktioner i samma modul måste ha unika namn.
