...
Ytterligare ett bra sätt att förstå hur en if-sats exekveras är att använda [pythontutor.com](https://pythontutor.com/visualize.html#mode=display) vi rekommenderade i kmom01.. Nedan finns exemplet i visualiseringsverktyget.
