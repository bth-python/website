...
Ytterligare ett bra sätt att förstå hur en if-sats exekveras är att använda [pythontutor.com](https://pythontutor.com/visualize.html#mode=display). Nedan finns exemplet i visualiseringsverktyget.
