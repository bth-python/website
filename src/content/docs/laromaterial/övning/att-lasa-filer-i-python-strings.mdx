---
title: Att läsa filer som strängar i Python
description: ""
---
...
cp -i example/file/string/items.txt src/kmom06/practice
cd src/kmom06/practice
```
...
Testa kör programmet, vi visar val som görs med `$x` i exemplet nedanför.
...
Tänk själv hur du hade löst följande fel:
