...
import var1Image from '@assets/img/ovning/variable-memory1.png'; import var2Image from '@assets/img/ovning/exceptions_top.png';
...
Vi har haft fokus på felhantering i Python. 
