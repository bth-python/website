...
<Image
    src={var1Image}
    alt="an_integer refererar till värdet 23 i minnet."
    class="right"
/>
...
<Image
    src={var2Image}
    alt="Flera variabler refererar till värden i minnet."
    class="right"
/>
...
<Image
    src={var4Image}
    alt="variabeln 'name' har värdet av det vi matade in till input()."
    class="right"
/>
...
<Image
    src={var5Image}
    alt="Variablerna 'name' och 'greeting' har värden i minnet."
    class="right"
/>
...
<Image
    src={var7Image}
    alt="Variabler refererar till värden i minnet."
    class="right"
/>
