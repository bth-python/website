...
Du har uppfyllt kraven i uppgiften kmom03 och har gjort en vanlig inlämning enligt [Resultat och redovisning](/website/laromaterial/instruktion/resultat-och-redovisning).
...
- `PG`/`0.98`: Preliminärt Godkänt. Testerna går igenom, nu ska du bara vänta på att en lärare kollar på din inlämning.
