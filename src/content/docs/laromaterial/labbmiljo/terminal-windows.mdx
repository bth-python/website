...
PS. Om du får upp en ruta ruta där det står att du använder `WSL 1` och de rekomenderar att du ska uppgradera till 2 istället, följ instruktionerna [Uppgradera wsl 1 till wsl 2](#upgradera-wsl-1-till-wsl-2).
