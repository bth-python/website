...
import code1 from '@assets/labbmiljö/vscode/code1.png';
...
import code2 from '@assets/labbmiljö/vscode/code2.png';
...
import code3 from '@assets/labbmiljö/vscode/code3.png';
