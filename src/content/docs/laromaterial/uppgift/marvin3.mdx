...
1. Testerna som finns ska passera.
    ```bash
    # kör testerna för kmom04 i ditt repo
    uv run task test -- kmom04
    # om du bara vill köra testerna för tag `pick`
    uv run task test -- kmom04 -t pick
    # flaggan -s visar vilka taggar som är aktuella för kmom04
    uv run task test -- kmom04 -s
    ```
