---
title: "Läsa och skriva filer"
description: En uppgift som handlar om att läsa från fil och att skriva till fil.
---

## Läsa och skriva filer i python

Du ska nu visa att du behärskar att läsa data från fil och att skriva data till fil i Python.


### Förkunskaper

Du har jobbat igenom artikeln [Att läsa filer som strängar i Python](/website/laromaterial/övning/att-lasa-filer-i-python-strings), [Att läsa filer till en lista i Python](/website/laromaterial/övning/att-lasa-filer-i-python).
