...
Programmering och problemlösning i Python, du skall bygga en chattbot Marvin som kan svara på "alla" dina frågor. Observera att i videon så finns det fler menyalternativ än de du ska implementera. Vilka du ska göra framgår senare i uppgiftsbeskrivningen.  
...
Så här: `uv run task test -- kmom02 -e`
:::
