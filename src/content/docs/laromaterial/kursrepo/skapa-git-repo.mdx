...
Du kan kontrollera att ditt repo nu innehåller 4 branches med kommandot `git --no-pager branch`, med det kommandot ser du också vilken branch du befinner dig i för närvarande.
