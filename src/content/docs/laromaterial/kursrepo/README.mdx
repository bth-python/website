...
Det finns ett [repo `python-abcd25`](https://github.com/bth-python/python-abcd25) som används i guiden och det är skapat enligt guiden och det innnehåller också övrig utvecklingsmiljö som studenten sätter upp under kursens gång. Detta repo innehåller också samtliga utvecklingsverktyg som behövs innan man kan sätta igång med kmom01.
...
Här är direktlänken till det exempelrepo som är skapat som en mirror, [`python-mirror`](https://github.com/bth-python/python-mirror).
...
Här är en direktlänk till hur du [skapar en fork av exempelrepot `python-abcd25`](https://github.com/bth-python/python-abcd25/fork).
...
Här är direktlänken till det exempelrepo som är forkat, [`python-fork`](https://github.com/bth-python/python-fork).
