...
För att spara ändringarna till git repot så kör vi kommandot `git commit` och samtidigt anger vi ett commit-meddelande om vad ändringen innebär. Dessa meddleande blir en del av repots commit-historik som berättar en historia om hur repot har utvecklats och förändrats.
...
git log 
# Tryck på "q" för att avsluta utskriften.
```
