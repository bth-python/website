...
För att köra testerna för den uppgiften måste vi skicka med sökvägen från där du står i terminalen till där testerna finns. Om du står i roten av kursrepot så är sökvägen `tests/kmom01/converter`.

```console title="Kör tester för converter uppgiften."
uv run tester tests/kmom01/converter
```

Du ska få up en lång felutskrift som avslutas med:
